  ...
  { icon: SiUbuntu, color: "#E95420" }
    ...
    return (
        <div id='Skills' className='relative -z-10 mx-auto mt-5 mb-5 overflow-hidden scroll-mt-20'>
            <h1 className='text-center heading text-2xl font-bold md:text-3xl md:mb-5'>My Skill's</h1>
            <div className="text-gray-600 text-xs md:text-xl text-center mb-5 p-5">
