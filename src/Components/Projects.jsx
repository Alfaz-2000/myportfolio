                ...
                <div className="left flex flex-col w-full md:w-1/2  p-5 md:px-10 space-y-1 md:space-y-4">
                    ...
                    <div className="sub-main text-xs md:text-base space-y-4">
                        ...
                        <div className=" flex gap-2 items-center">
                            ...
                            <span>A professional digital presence for the travel business</span>
                        </div>
                        <div className=" flex gap-2 items-center">
                            <IoArrowForwardCircleOutline className='text-[#0f0]' />
                            <span>Travel services and offerings in a clear, structured format</span>
                        </div>
                        <div className=" flex gap-2 items-center">
                            <IoArrowForwardCircleOutline className='text-[#0f0]' />
                            <span>Customer trust through a professional and user-friendly website</span>
                        </div>
                        <div className=" flex gap-2 items-center">
                            <IoArrowForwardCircleOutline className='text-[#0f0]' />
                            <span>Inquiry flow to help convert visitors into potential customers</span>
                        </div>
                        <div className="visitlink ">
                            <a href="https://al-kiswah-travels.vercel.app" className=" flex gap-3 mt-4 px-4 items-center text-gray-600 font-medium hover:underline" target="_blank" rel="noopener noreferrer"><span>Visit Website</span><GoLinkExternal /></a>
                        </div>
                    </div>
                </div>
                <div className="right w-full md:w-1/2">
                    <div className="p-10">
                        <img className='w-full' src="/ak-transferent.png" alt="" />
                    </div>
                </div>
            </div>
            <div className="rnelevators flex flex-col-reverse md:flex-row w-full min-h-[80vh] justify-center items-center p-2 md:p-10">
